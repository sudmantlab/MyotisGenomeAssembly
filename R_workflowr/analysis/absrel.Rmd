...
df.manhattan.topgenesPerChrPerSpc <- df.val.geneID.all %>% 
...
df.manhattan.sharedselection3 <- df.val.geneID.all %>% 
...
```{r, eval=F}
list.geneid.ourMyotis <- df.val.geneID.all %>% 
  filter(pval<=0.05) %>% 
...
dir.create('../output/webGestalt/absrel_toMyoOccEvoThy')

lapply(
  df_nodes_toleft$label,
  . %>% 
    str_c('../output/webGestalt/absrel_toMyoOccEvoThy/',.) %>% 
    dir.create(.)
)
...
list.toleft %>% 
  ...
  lapply(
    ...
    function(n, l=list.toleft){
      l[[n]] %>% 
    pull(human_gene_name) %>% 
    write_lines(str_c('../output/webGestalt/absrel_toMyoOccEvoThy/',n,'/absrel-',n,'.txt'))
    }
  )

dir.create(str_c('../output/webGestalt/absrel_toMyoOccEvoThy/union-toOcc'))
dir.create(str_c('../output/webGestalt/absrel_toMyoOccEvoThy/union-toEvo'))
dir.create(str_c('../output/webGestalt/absrel_toMyoOccEvoThy/union-toThy'))
...
df.omega.toleft %>% 
  ...
  pull(human_gene_name) %>% unique %>% write_lines('../output/webGestalt/absrel_toMyoOccEvoThy/union-toOcc/absrel-genesToOcc.txt')
...
df.omega.toleft %>% 
  ...
  pull(human_gene_name) %>% unique %>% write_lines('../output/webGestalt/absrel_toMyoOccEvoThy/union-toEvo/absrel-genesToEvo.txt')
...
df.omega.toleft %>% 
  ...
  pull(human_gene_name) %>% unique %>% write_lines('../output/webGestalt/absrel_toMyoOccEvoThy/union-toThy/absrel-genesToThy.txt')
