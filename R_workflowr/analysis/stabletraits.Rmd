...
```{r plot all mammals, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
plot(
...
```{r plot bats vs others, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
plot(
  lifesize.dat.noNode$lnLife~lifesize.dat.noNode$lnSize,
  col="white",
  pch=21,
...
```{r, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
...
```{r plot yinptero vs yango, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
plot(data$Dependent~data$Independent,col="white",pch=21,xlab="", ylab="",asp=1,cex.lab=2) 
pGLS.plotGrade(
...
```{r plot bat subtypes, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
plot(data$Dependent~data$Independent,col="white",pch=21,xlab="", ylab="",asp=1,cex.lab=2) 
pGLS.plotGrade(
  'Dependent','Independent',
  tree = tree, data=data,
...
```{r plot bat subtypes without auriculus, fig.height = 4, warnings = F, error = F, fig.width = 6, fig.align = "center"}
plot(data$Dependent~data$Independent,col="white",pch=21,xlab="", ylab="",asp=1,cex.lab=2) 
pGLS.plotGrade(
  'Dependent','Independent',
  tree = tree, data=data,
