...
tr <- treeio::read.newick("../../data/tree/genomeSpecies.timetree.nwk")
...
t2t.bartop = p.tr.auNG.circ.altcolor$layers[[5]]$data %>% filter(label == 'Homo_sapiens') %>% pull(new_xtmp)
